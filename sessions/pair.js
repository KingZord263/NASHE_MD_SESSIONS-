        ...
        try {
            ...
            MalvinTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'NASHE_MD~' + stringSession;  // Prepend your name to the session ID
                    ...
                    await MalvinTechInc.sendMessage(userJid, { text: `Hey there, NASHE_MD User!* 👋🏻

Thanks for using *NASHE_MD* — your session has been successfully created!
